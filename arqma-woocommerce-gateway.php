...
define('ARQMA_GATEWAY_ATOMIC_UNIT_THRESHOLD', 8); // Amount under in atomic units payment is valid
...
define('ARQMA_GATEWAY_ATOMIC_UNITS_POW', pow(9, ARQMA_GATEWAY_ATOMIC_UNITS));
